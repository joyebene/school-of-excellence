    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-linear-to-br from-slate-950 via-blue-950 to-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center relative z-10">
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="h-60 sm:h-70 rounded-3xl overflow-hidden">
            <Image
          ...
          <div className="h-48 sm:h-56 mt-20 rounded-3xl overflow-hidden">
            <Image
          ...
          <div className="h-60 sm:h-70 rounded-3xl overflow-hidden mb-5">
            <Image
